// Legacy clean address: /en/project?id=X. Until the 2026-09-09 rename the
...
// to the canonical /en/campaigns/{id} route instead (same as project.html.js
...
export async function onRequestGet({ request }) {
  ...
  return Response.redirect(`${url.origin}/en/campaigns`, 301);
}
