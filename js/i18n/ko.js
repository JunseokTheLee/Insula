...
const T = {
  ...
  // ── 별자리 (2026-09-21) ──────────────────────────────────────────────
  // 모양 이름과 한 줄 문구 (js/constellations.js 의 key 와 짝)
  conName_firstStep: '첫 걸음', conLine_firstStep: '무엇이든 한 칸에서 시작됩니다.',
  conName_hope: '희망', conLine_hope: '작은 조각이 더 밝은 세상을 만듭니다.',
  conName_growth: '성장', conLine_growth: '어제보다 조금 더 자란 하늘입니다.',
  conName_connection: '연결', conLine_connection: '떨어져 있던 별들이 서로를 찾았습니다.',
  conName_courage: '용기', conLine_courage: '처음 해보는 일에는 언제나 용기가 듭니다.',
  conName_company: '동행', conLine_company: '서로 다른 길이 한 곳에서 만났습니다.',
  conName_quietNight: '고요한 밤', conLine_quietNight: '조용한 시간에도 하늘은 자랍니다.',
  conName_wave: '물결', conLine_wave: '천천히, 그러나 멈추지 않고.',
  conName_lantern: '등불', conLine_lantern: '누군가의 밤을 밝히는 불빛이 됩니다.',
  ...
  starsLead: '게임에서 작품을 하나 완성할 때마다 별이 하나 켜집니다. 별 6개가 모이면 별자리가 되고, 완성한 별자리는 모두가 함께 만드는 고래의 별이 됩니다.',
  ...
  starsWhaleTitle: '함께 만드는 고래',
  starsWhaleLead: '누군가 별자리를 하나 완성할 때마다 고래의 별이 하나 켜집니다. 한 사람이 켤 수 있는 별은 최대 {cap}개라, 고래는 여럿이 있어야 완성됩니다.',
  starsWhaleProgress: '별 {n} / {total}',
  starsWhaleMine: '내가 켠 별 {n}개',
  starsWhaleDone: '고래가 완성되었습니다!',
  starsWhaleBy: '{name} 님의 {nth}번째 별자리',
  starsWhaleAnon: '이름을 밝히지 않은 회원',
