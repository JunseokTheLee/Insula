...
const T = {
  ...
  starsFullTitle: '내 별자리 전체 · {n}개 완성',
  starsRotateHint: '휴대폰을 가로로 돌리면 고래가 더 크게 보입니다.',
  starsWhaleLead: '별자리가 이야기의 한 장이라면, 고래는 그림 전체입니다. 당신이 밝힌 별이 머리에서 꼬리까지 차례로 이어져, 별 {total}개로 고래 한 마리가 완성됩니다.',
  starsWhaleProgress: '별 {n} / {total}',
  starsWhaleDone: '고래를 완성했습니다!',
