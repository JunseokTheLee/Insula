...
const T = {
  ...
  starsFullTitle: 'All my constellations · {n} complete',
  starsRotateHint: 'Turn your phone sideways to see the whale bigger.',
  starsWhaleLead: 'If a constellation is one chapter, the whale is the whole picture. Your stars join it head to tail, and {total} of them complete one whale.',
  starsWhaleProgress: '{n} / {total} stars',
  starsWhaleDone: 'You completed the whale!',
