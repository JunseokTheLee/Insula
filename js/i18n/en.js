...
const T = {
  ...
  // Shape names and lines (keys match js/constellations.js)
  conName_firstStep: 'First Steps', conLine_firstStep: 'Everything starts with a single cell.',
  conName_hope: 'Hope', conLine_hope: 'Small pieces make a brighter world.',
  conName_growth: 'Growth', conLine_growth: 'A sky a little taller than yesterday.',
  conName_connection: 'Connection', conLine_connection: 'Stars that were apart found each other.',
  conName_courage: 'Courage', conLine_courage: 'Anything new takes a little courage.',
  conName_company: 'Company', conLine_company: 'Different paths met in one place.',
  conName_quietNight: 'Quiet Night', conLine_quietNight: 'The sky grows in quiet hours too.',
  conName_wave: 'Wave', conLine_wave: 'Slowly, but without stopping.',
  conName_lantern: 'Lantern', conLine_lantern: 'A light for somebody else\'s night.',
  ...
  starsLead: 'Finishing an artwork in either game lights one star. Six stars make a constellation, and every constellation anyone completes lights a star of the whale we build together.',
  ...
  starsWhaleTitle: 'The whale we build together',
  starsWhaleLead: 'Every constellation somebody completes lights one star of the whale. One person can light at most {cap}, so the whale only finishes with many of us.',
  starsWhaleProgress: '{n} / {total} stars',
  starsWhaleMine: '{n} lit by you',
  starsWhaleDone: 'The whale is complete!',
  starsWhaleBy: '{name} · constellation {nth}',
  starsWhaleAnon: 'A member who stays unnamed',
  ...
  starWhaleLit: 'A star of the whale now carries your name',
  ...
  starsCardDesc: 'Your stars and constellations, and the whale we share',
